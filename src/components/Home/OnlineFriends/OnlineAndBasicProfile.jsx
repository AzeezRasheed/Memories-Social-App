...
const Container = styled.div`
  ${tw`   flex-col flex h-full pt-4 px-6 gap-6   `}
`;
...
const Title = styled.h1`
  ${tw`w-72 font-bold text-gray-500 text-sm items-start`}
`;

const SeeAll = styled.li`
  ${tw`text-black flex w-20 hover:text-gray-500   font-bold text-xs list-none items-end `}
`;

const Followers = styled.div`
  ${tw`
  flex flex-col items-start gap-4 justify-center w-full
`}
`;
...
const Avatar = styled.div`
  ${tw`   h-full overflow-hidden rounded-full `}
`;
...
const ButtonContainer = styled.div`
  ${tw`flex flex-row justify-between gap-2`}
`;
const Button = styled.button`
  ${tw`w-full py-2 rounded p-2 cursor-pointer items-center text-center`}
`;

const AcceptButton = styled(Button)`
  ${tw` bg-blue-400 hover:bg-white transition ease-in-out duration-75 font-bold text-sm`}
`;
const RejectButton = styled(Button)`
  ${tw`bg-white hover:bg-blue-400  transition ease-in-out duration-75 font-bold text-sm`}
`;
...
const ProfileInfo = styled.div`
  ${tw` flex flex-col gap-1 text-start items-start `}
`;
...
const Username = styled.h2`
  ${tw`text-sm font-bold text-black font-bold`}
`;

const RightButton = styled.button`
  ${tw` text-[12px] text-blue-500  flex-1 font-bold`}
`;
function OnlineAndBasicProfile() {
  return (
    <Container>
      <BasicProfile>
        <div className="flex flex-row gap-2 items-center w-full ">
          ...
          <ProfileInfo>
            <Username>Rashie 10k</Username>
            <FullName>Abdulazeez Abdulrasheed</FullName>
          </ProfileInfo>
        </div>
        <RightButton>Switch</RightButton>
      </BasicProfile>
      <div className="flex flex-col   gap-4 w-full pl-2 ">
        <TopHeader>
          <Title>Look who's online</Title>
          <SeeAll>
...
export default OnlineAndBasicProfile;
